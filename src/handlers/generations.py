...
async def show_packages(
    ...
    text = (
        ...
        "ℹ️ Ссылка на оплату действует 24 часа, "
        "после чего автоматически аннулируется.\n"
        "⚠️ При оплате картой Сбербанка платёжная "
        "система может взимать комиссию ~50 ₽ "
        "сверх суммы пакета — это не наша комиссия.\n"
        "Другие банки (Тинькофф, ВТБ, Альфа-Банк и т.д.) "
        "обычно проводят оплату без доп. комиссии."
    )
...
async def buy_package(
    ...
    await callback.message.answer(
        (
            ...
            "⏳ Ссылка действительна 24 часа, затем аннулируется автоматически.\n"
            "⚠️ При оплате картой Сбербанка платёжная система "
            "может взять комиссию ~50 ₽ сверх суммы пакета.\n"
            "Так же и другие банки могут брать свою комиссию "
            "(Тинькофф, ВТБ, Альфа-Банк и т.д.)\n\n"
